...
//Last modified: Mon, Nov 04, 2024 03:43:14 PM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "02BEB9DC-45CE-3F5D-CC9A-DE8D5D2BF4CA";
createNode transform -n "hierarchy_representation";
	rename -uid "EA0839A6-4E50-3C5B-268C-8DBB08DE2000";
createNode nurbsSurface -n "hierarchy_representationShape" -p "hierarchy_representation";
	rename -uid "68717BE5-4533-9178-5444-E2813E9CCBA0";
...
createNode transform -n "hierarchy_arrow_representation" -p "hierarchy_representation";
	rename -uid "390D3219-4496-47FC-5984-FF9EA143AD58";
...
createNode mesh -n "hierarchy_arrow_representationShape" -p "hierarchy_arrow_representation";
	rename -uid "4C52EEFE-44B0-F4DB-3423-46928AAD66CD";
	addAttr -ci true -sn "mso" -ln "miShadingSamplesOverride" -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "msh" -ln "miShadingSamples" -min 0 -smx 8 -at "float";
	addAttr -ci true -sn "mdo" -ln "miMaxDisplaceOverride" -min 0 -max 1 -at "bool";
	addAttr -ci true -sn "mmd" -ln "miMaxDisplace" -min 0 -smx 1 -at "float";
...
createNode transform -s -n "persp";
	rename -uid "DD95A38A-4581-312F-E2D9-B5B9D1552C9E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.70544727820563291 2.3346216977404088 2.9038078150001785 ;
	setAttr ".r" -type "double3" -36.938352729603444 9.4000000000001851 4.0298049210648966e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "3D690BC6-48D6-EFBA-079F-5993B20D322A";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 3.7848925595563649;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "F0C4F4EE-4440-89FA-AB4B-3AA96DF93A5D";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -90 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "7EE22574-446F-BDFD-C660-54969FCD49CF";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "380B36E4-484A-C0DB-9C2C-3DA53BB9F843";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "C04135BC-4AD6-EDB7-324F-2E821E1C7C8A";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "C81B2E62-4723-BC38-C2F2-5FAB9C83A464";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 90 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "0D4C8CE7-4DC0-1891-0748-E2BFE2A2AB95";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode container -n "hierarchy_representation_container";
	rename -uid "2DCE2A80-4547-60B6-A7E0-47B7FAB03FE7";
...
createNode lambert -n "m_hierarchyRepresentation";
	rename -uid "9E6583F1-4062-091F-451C-B8BA9501E07B";
	setAttr ".dc" 0;
	setAttr ".c" -type "float3" 0 0.1882 0.34110001 ;
	setAttr ".ambc" -type "float3" 1 1 1 ;
createNode hyperLayout -n "hyperLayout1";
	rename -uid "8822BD3D-40F8-51A8-4EFE-0388653C3C57";
	setAttr ".ihi" 0;
	setAttr -s 6 ".hyp";
	setAttr ".hyp[1].x" 71;
	setAttr ".hyp[1].y" 93;
...
createNode shadingEngine -n "m_hookRepresentation_SG";
	rename -uid "14E94F67-4220-9F3B-840E-03A9DD1982CF";
	setAttr ".ihi" 0;
	setAttr -s 2 ".dsm";
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "01642EB6-4069-C2F1-F6EE-91B84E18727C";
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E900E49E-4A06-101D-C205-3DBBAABA023A";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "8D46097A-4996-9149-980A-279FB3BD749C";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "7E7E2F5E-48F6-200C-7A9C-37B35951C7A8";
createNode displayLayerManager -n "layerManager";
	rename -uid "A0A512BB-41D8-FEBE-371E-91856741230B";
createNode displayLayer -n "defaultLayer";
	rename -uid "CEE57E61-4944-6F28-0C97-5E9ECFF31735";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "EF0B333E-4A29-2211-D81E-2BBC4B0F89CD";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "FF9718C2-4AF8-86C0-9C57-C18436C9C050";
	setAttr ".g" yes;
createNode script -n "uiConfigurationScriptNode";
	rename -uid "3365A352-4FC6-F295-AD49-518858686181";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "BA80B7AA-4AAC-B5D6-FEDC-E9AF24CB0606";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 120 -ast 1 -aet 200 ";
	setAttr ".st" 6;
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "D3F97825-4067-BFC2-A5D9-00B9B9654084";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -355.55554142704773 -336.50792313631302 ;
	setAttr ".tgi[0].vh" -type "double2" 355.55554142704773 335.71427237419908 ;
select -ne :time1;
	setAttr -av -k on ".cch";
	setAttr -k on ".fzn";
...
relationship "link" ":lightLinker1" "m_hookRepresentation_SG.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialShadingGroup.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" ":initialParticleSE.message" ":defaultLightSet.message";
relationship "shadowLink" ":lightLinker1" "m_hookRepresentation_SG.message" ":defaultLightSet.message";
