...
//Last modified: Mon, Nov 04, 2024 03:42:52 PM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "8ADB1966-40C6-A4B9-A154-2DAB59D7AD83";
createNode transform -s -n "persp";
	rename -uid "BC875A9E-44C2-AD88-44EC-1084FC0A7755";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 28 21 28 ;
	setAttr ".r" -type "double3" -27.938352729602379 44.999999999999972 -5.172681101354183e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "4DF6069F-43B4-E650-6A9C-97BBD4369259";
	setAttr -k off ".v" no;
...
createNode transform -s -n "top";
	rename -uid "19BCDBA6-4DDB-60B4-2492-4AAFDB726BDC";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -90 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "FEDBA3AE-4B80-9580-6BB0-4099FBAC611D";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "C8D8A5C0-42AD-79E1-DD75-51A418DBE6DC";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "87157149-43FA-CE4B-49FB-A8B93ECB4DA2";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "36FE30E1-447E-AE26-D414-E9B9D4555DEE";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 90 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "F884CB48-42B9-67CA-DCE0-3C9A365C1EBA";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -n "controlGroup_control";
	rename -uid "805F542E-45B1-F6A1-189B-2BADFE6669B1";
createNode mesh -n "controlGroup_controlShape" -p "controlGroup_control";
	rename -uid "5D696ADE-43C2-8571-0FD9-A9BBCCE2E23F";
	setAttr -k off ".v";
	setAttr ".ovs" no;
	setAttr ".ove" yes;
	setAttr ".ovc" 4;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4E34FB43-46C2-0738-6EAA-CB9089A5901E";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "67E1B117-4272-1D25-6257-68AB0BD897E7";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "984EB9DB-45A5-E70C-B29C-BC882D562E47";
createNode displayLayerManager -n "layerManager";
	rename -uid "B84559AB-409A-CE25-D014-4B8C8EA22D9D";
createNode displayLayer -n "defaultLayer";
	rename -uid "5D1A89BB-410C-0701-DFCD-33AA525D082B";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C8D578A9-4EB6-F61A-E4E8-AC99AF11C889";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "FDA4C26A-4548-C87D-C121-99A038D6C836";
	setAttr ".g" yes;
createNode script -n "uiConfigurationScriptNode";
	rename -uid "8FCC68D2-491F-C03F-579C-E0BDD4D16256";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "E7A08CD0-4012-B68C-2A75-35BCBD6C01BE";
