...
MAYA_INDEX_COLORS = list(colors.MAYA_INDEX_QCOLORS)
DEFAULT_CONTROL_COLOR = QtGui.QColor(colors.DEFAULT_COLOR_QCOLOR)
...
COLOR_PALETTES = {
    ...
    "Middle": _build_palette(saturation=0.65, value=1.0),
    "Faded": _build_palette(saturation=0.25, value=1.0),
    # Back-compat: older builds used "Spectrum"
